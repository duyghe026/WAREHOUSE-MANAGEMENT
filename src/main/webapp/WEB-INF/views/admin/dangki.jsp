...
<body>
	<div class="ui middle aligned center aligned grid">
		<div class="column">
			...
			<form:form class="ui large form" action="dangki" modelAttribute="taiKhoan" method="post">
				<div class="ui stacked segment">
					<div class="field">
						<div class="ui left icon input">
							<i class="user icon"></i>
							<form:input type="text" path="username" placeholder="Tài Khoản" />
						</div>
						<div style="color: red">
					...
					<div class="field">
						<form:select path="nhanVien.maNV" items="${dsNhanVien}" itemValue="maNV" itemLabel="fullName" />
					</div>
					<div class="field">
						<h2>${message}</h2>
					</div>
