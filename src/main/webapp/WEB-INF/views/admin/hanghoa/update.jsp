	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<h2 class="ui header" style="margin-top: 20px">SỬA HÀNG HÓA</h2>
			</div>
			<div class="ui grid stackable padded">
				<div class="column">
					<form:form class="ui form" action="admin/hanghoa/update" method="post" enctype="multipart/form-data"
						modelAttribute="hangHoa">
						<div class="ui two column centered grid">
							<div class="column">
								<label>Mã Hàng Hóa</label>
								<form:input type="text" path="maHangHoa" readonly="true" />
							</div>
							<div class="column">
							...
							<div class="column">
								...
								<form:input type="number" path="giamGia" min="0" max="99" />
							</div>
							<form:input path="soLuong" value="${soLuong}" type="hidden" />
							<div class="column">
