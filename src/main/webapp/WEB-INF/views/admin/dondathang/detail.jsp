	...
	<div class="pusher">
		<div class="main-content">
			<div class="ui grid stackable padded">
				<h2 class="ui header" style="margin-top: 20px">CHI TIẾT ĐƠN ĐẶT HÀNG</h2>
			</div>
			<div class="ui grid stackable padded">
				<div class="column">
					...
					<h5 class="ui right header" style="margin-top: 20px"> CHIẾC KHẤU :
                    		${donDatHang.daiLy.chiecKhau} %
                    </h5>
					<h5 class="ui right header" style="margin-top: 20px"> TỔNG TIỀN :
						<f:formatNumber type="currency" maxFractionDigits="0" currencySymbol=""
							value="${donDatHang.tongTien}" /> đ
					</h5>
					<a href="admin/dondathang/index"><button class="ui button">Trở
							Lại</button></a>
				</div>
			</div>
		</div>
